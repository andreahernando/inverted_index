...
public class InvertedIndex {
    public static Map<String, HashSet<Integer>> invertedIndex(String str) throws IOException {
        ...
        List<String> stopwords = Files.readAllLines(Paths.get("C:\\Users\\Usuario\\Desktop\\UNI\\3º GCID\\Primer Semestre\\BD\\Grupal 2 - Crawler development\\english_stopwords.txt")); //remove stopwords
